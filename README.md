...
- [Trading Intelligence API](https://signal-engine-production-d88d.up.railway.app) — Directional crypto trading signals fusing social sentiment, macro regime, and market structure. $0.001–$0.050 USDC per call on Base. 25 free credits per wallet. [Landing](https://landing-production-6660.up.railway.app)
